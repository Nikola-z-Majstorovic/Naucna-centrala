  ...
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('da', {
        ...
        groupPanel:{
          description: 'Grupér rakker udfra en kolonne ved at trakke dens overskift hertil.'
        },
        search:{
          placeholder: 'Sog...',
          showingItems: 'Viste rakker:',
          selectedItems: 'Valgte rakker:',
          totalItems: 'Rakker totalt:',
          size: 'Side storrelse:',
          first: 'Forste side',
          next: 'Naste side',
  ...
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('fr', {
        ...
        groupPanel: {
          description: 'Faites glisser un en-tete de colonne ici et déposez-le vers un groupe par cette colonne.'
        },
        search: {
        ...
        pinning: {
          pinLeft: 'Épingler a gauche',
          pinRight: 'Épingler a droite',
          unpin: 'Détacher'
        },
        gridMenu: {
          columns: 'Colonnes:',
        ...
        importer: {
          noHeaders: 'Impossible de déterminer le nom des colonnes, le fichier possede-t-il un en-tete ?',
          noObjects: 'Aucun objet trouvé, le fichier possede-t-il des données autres que l\'en-tete ?',
          invalidCsv: 'Le fichier n\'a pas pu etre traité, le CSV est-il valide ?',
          invalidJson: 'Le fichier n\'a pas pu etre traité, le JSON est-il valide ?',
  ...
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('pt-br', {
        ...
        importer: {
          noHeaders: 'Nomes de colunas nao puderam ser derivados. O arquivo tem um cabeçalho?',
          noObjects: 'Objetos nao puderam ser derivados. Havia dados no arquivo, além dos cabeçalhos?',
          invalidCsv: 'Arquivo nao pode ser processado. É um CSV válido?',
          invalidJson: 'Arquivo nao pode ser processado. É um Json válido?',
  ...
  angular.module('ui.grid').config(['$provide', function($provide) {
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('sk', {
        ...
        groupPanel: {
          description: 'Pretiahni sem názov ståpca pre zoskupenie pod¾a toho ståpca.'
        },
        search: {
          placeholder: 'H¾adaj...',
          showingItems: 'Zobrazujem položky:',
          selectedItems: 'Vybraté položky:',
          totalItems: 'Poèet položiek:',
          size: 'Poèet:',
          first: 'Prvá strana',
          next: 'Ïalšia strana',
        ...
        sort: {
          ascending: 'Zotriedi vzostupne',
          descending: 'Zotriedi zostupne',
          remove: 'Vymaza triedenie'
        },
        aggregation: {
          count: 'total rows: ',
          sum: 'total: ',
    ...
    $provide.decorator('i18nService', ['$delegate', function($delegate) {
      $delegate.add('sv', {
        ...
        importer: {
          ...
          jsonNotArray: 'Importerad JSON-fil maste innehalla ett fält. Import avbruten.'
        },
        pagination: {
